...
const TIERS = [
    {
        ...
        features: [
            ...
            { text: "All AI models (GPT-4, Claude 3, Gemini)", included: true },
            { text: "Web dashboard access", included: true },
            { text: "30-day prompt history", included: true },
            { text: "Email support", included: true },
            { text: "Project Protocol (5 credits each)", included: true },
            { text: "MCP/API access", included: false },
        ],
        cta: "Get Started",
    },
    {
        ...
        features: [
            ...
            { text: "Web dashboard access", included: true },
            { text: "90-day prompt history", included: true },
